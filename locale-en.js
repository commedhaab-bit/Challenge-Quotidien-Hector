...
const LOCALE_EN = {
  ...
  groups: {
    ...
    jokers: {
      ...
      bouletConfirmSubtitleTarget: '{{name}} starts with a 20-point handicap on this challenge\'s settlement ranking (never goes below 0, no effect on their real rep count). One joker per challenge!',
