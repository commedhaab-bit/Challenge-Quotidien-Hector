...
const LOCALE_ES = {
  ...
  groups: {
    ...
    jokers: {
      ...
      bouletBtn: 'El Lastre (+20 de hándicap a un rival)',
      bouletConfirmTitle: '¿Lanzar El Lastre?',
      bouletConfirmSubtitleTarget: '{{name}} empieza con un hándicap de 20 en la clasificación del ajuste de este reto (nunca baja de 0, sin efecto en sus repeticiones reales). ¡Un solo comodín por reto!',
